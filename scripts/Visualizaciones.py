...
#%%===========================================================================
# Importamos todas los resultados de las consultas
#=============================================================================
carpeta_consultas = "../data/processed/"

Consulta1 = pd.read_csv(carpeta_consultas + "Consulta1.csv")
Consulta2 = pd.read_csv(carpeta_consultas+"Consulta2.csv")
Consulta3= pd.read_csv(carpeta_consultas+"Consulta3.csv")
Consulta4= pd.read_csv(carpeta_consultas+"Consulta4.csv")

from Consultas import ProvinciaYDepartamento
...
#%%===========================================================================
# Configuro la ruta para guardar los graficos
#=============================================================================
ruta_vis = "../docs/visualizaciones/"
os.makedirs(ruta_vis, exist_ok=True)
#%%===========================================================================
#VISUALIZACION 1
#=============================================================================
...
#renombro tierra del fuego para que quede mas cortito
V1['provincia'] = V1['provincia'].replace("Tierra del Fuego, Antártida e Islas del Atlántico Sur", "Tierra del Fuego")
...
#Exporto
plt.savefig(ruta_vis + "01_grafico_empleados_provincia.png", bbox_inches='tight', dpi=300)
plt.show()
...
plt.tight_layout()
#Exporto
plt.savefig(ruta_vis + "02_grafico_establecientos_vs_poblacion.png", bbox_inches='tight', dpi=300)
plt.show()
...
#Exporto
plt.savefig(ruta_vis + "03_grafico_boxplot.png", bbox_inches='tight', dpi=300)
plt.show()
...
#Exporto
plt.savefig(ruta_vis + "04_grafico_relacion_empleados_establecimientos.png", bbox_inches='tight', dpi=300)
plt.show()
...
#Exporto
plt.savefig(ruta_vis + "05_grafico_proporcion_mujeres_por_actividad.png", bbox_inches='tight', dpi=300)
plt.show()
