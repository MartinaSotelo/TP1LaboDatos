...
#=============================================================================
ruta_salida = "../data/interim/limpieza/"
os.makedirs(ruta_salida, exist_ok=True)

padron_poblacion_acomodado.to_csv(ruta_salida + "PadronPoblacionLimpio.csv", index=False)
dep_ac_sex_limpio.to_csv(ruta_salida + "DepartamentoActivdadySexoLimpio.csv", index=False)
Padron_ee_limpio.to_csv(ruta_salida + "PadronEstablecimientosEducativosLimpio.csv",index=False)
