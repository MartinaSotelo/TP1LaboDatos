...
#=============================================================================
ruta_salida = "../data/interim/modelo/"
os.makedirs(ruta_salida, exist_ok=True)

Departamento_EstablecimientoEducativo.to_csv(ruta_salida + "Departamento_EstablecimientoEducativo.csv", index=False)
ActividadProductiva_Departamento.to_csv(ruta_salida + "ActividadProductiva_Departamento.csv",index=False)
RangoEdades_NivelEducativo.to_csv(ruta_salida + "RangoEdades_NivelEducativo.csv",index=False)
EstablecimientoEducativo_NivelEducativo.to_csv(ruta_salida + "EstablecimientoEducativo_NivelEducativo.csv",index=False)
Departamento_RangoEdades.to_csv(ruta_salida + "Departamento_RangoEdades.csv",index=False)
Departamento_Provincia.to_csv(ruta_salida + "Departamento_Provincia.csv",index=False)
RangoEdades.to_csv(ruta_salida + "RangoEdades.csv",index=False)
ActividadProductiva.to_csv(ruta_salida + "ActividadProductiva.csv",index=False)
NivelEducativo.to_csv(ruta_salida + "NivelEducativo.csv",index=False)
EstablecimientoEducativo.to_csv(ruta_salida + "EstablecimientoEducativo.csv",index=False)
Departamento.to_csv(ruta_salida + "Departamento.csv",index=False)
Provincia.to_csv(ruta_salida + "Provincia.csv",index=False)
