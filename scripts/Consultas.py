...
#=============================================================================
ruta_final = "../data/processed/"
os.makedirs(ruta_final, exist_ok=True)

CONSULTA4.to_csv(ruta_final + "Consulta4.csv", index=False)
CONSULTA3.to_csv(ruta_final + "Consulta3.csv", index=False)
CONSULTA2.to_csv(ruta_final + "Consulta2.csv", index=False)
CONSULTA1.to_csv(ruta_final + "Consulta1.csv", index=False)
